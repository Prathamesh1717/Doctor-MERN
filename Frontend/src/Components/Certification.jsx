...
Government recognized and internationally aacredited healthcare
            </p>
...
<style dangerouslySetInnerHTML={{ __html: certificationStyles.animationStyles }} />    </div>
  )
}

export default Certification;
// className = {certificationStyles.}