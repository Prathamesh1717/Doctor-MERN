...
const Navbar = () => {
  ...
  //hide navbar when doctor logs in from doctor admin panel and show when they log out
  useEffect(() => {
    const onStorage = (e) => {
  ...
  return (
   ...
   <button onClick={() =>{ setIsOpen(false); clerk.openSignIn()}} className={navbarStyles.mobileLoginButton}>
    Login
   </button>
    </div>
