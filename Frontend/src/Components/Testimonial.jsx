...
{[...leftTestimonials,...leftTestimonials].map((t, i) => (
    <TestimonialCard key={`L-${i}`} testimonial={t} direction= "left" />
        ...
        <div className ={`${testimonialStyles.columnContainer} ${testimonialStyles.rightCardBorder}`}>
            <div className ={`${testimonialStyles.columnHeader} ${testimonialStyles.rightColumnHeader}`}>
🧑‍💼 Patients
            </div>
            <div onTouchStart={() => setIsPaused(true)} onTouchEnd={() => setIsPaused(false)} ref={scrollRefRight} className = {testimonialStyles.scrollContainer} >
