...
// Normalize doctor data from various sources into a consistent format
...
const DashboardPage = () => {
    ...
    const [patientCountLoading, setPatientCountLoading] = React.useState(false);
  ...
  //to derive totals and filtered doctors list
  ...
  //to filter doctors based on search query
    ...
    <div className= {s.pageContainer}>
        ...
        <div className= "mb-6">
          ...
          <div className= {s.searchContainer}>
            ...
            <button onClick={()=> {setQuery(""); setShowAll(false)}} className= {s.clearButton + " " + s.cursorPointer}>
              Clear 
            </button>
          </div>
        </div>
       ...
       <div className= {s.tableContainer}>
            <div className= {s.tableHeader}>
             ...
             <p className= {s.tableCount}> {loading ? "Loading..." : `${visibleDoctors.length} of ${filteredDoctors.length}`}</p>
            </div>
         {error && (
    ...
    <div className= {s.mobileDoctorSpecialization}>{d.specialization}</div>
      ...
      <div className= {s.mobileStatsGrid}>
        ...
        <div>
          ...
          <div className= {s.mobileStatValue + " " + s.textRose500}>{d.appointments.canceled}
          </div>
        </div>
         </div>
