...
//give output in minute and manage am and pm
...
const AddPage = () => {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = "https://doctor-mern-backend-l6gr.onrender.com/api";
