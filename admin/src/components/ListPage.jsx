...
import { BadgeIndianRupee, EyeClosed, Search, Star, Trash2, User } from 'lucide-react';
//Helper Functions

//gives ouput as DD-MM-YYYY
...
//normalize schedule map: ex: 'YYYY-MM-DD' : [slot1,slot2]
...
const API_BASE = "https://doctor-mern-backend-l6gr.onrender.com";
  ...
  //to fetch doctors coming from server side
  ...
  //fetch doctor each time we loading
  useEffect(() => {
    fetchDoctors();
  }, []);
...
<Trash2 size={14} /> Delete
    ...
    <div className= {doctorListStyles.feesValue}>
      <BadgeIndianRupee /> {doc.fee}
          ...
          {/* expanded content for particular doctor */}
            <div
