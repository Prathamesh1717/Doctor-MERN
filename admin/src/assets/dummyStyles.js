...
export const navbarStyles = {
  // Layout styles
  header: "relative font-serif w-full border-b border-emerald-100 bg-white",
  navContainer:
    "mx-auto w-full max-w-[1600px] px-3 sm:px-6 lg:px-10 xl:px-14 py-3",
  flexContainer:
    "flex items-center justify-between gap-3 lg:gap-6 w-full",

  // Logo section styles
  logoContainer:
    "flex items-center gap-2 sm:gap-3 shrink-0 min-w-fit",
  logoImage:
    "w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full object-cover",
  logoLink:
    "text-xl sm:text-2xl lg:text-3xl font-bold text-green-700 leading-tight whitespace-nowrap",
  logoSubtext:
    "text-[10px] sm:text-xs lg:text-sm text-gray-500 leading-tight whitespace-nowrap",

  // Center navigation (desktop)
  centerNavContainer:
    "hidden md:flex flex-1 justify-center min-w-0",
  glowEffect:
    "w-full max-w-[1100px] rounded-3xl p-1 bg-gradient-to-r from-emerald-100 via-emerald-200 to-emerald-100 shadow-md",
  centerNavInner:
    "w-full",
  centerNavScrollContainer:
    "flex items-stretch justify-evenly w-full rounded-3xl bg-white/95 px-2 sm:px-3 lg:px-4 py-2 border border-gray-100 shadow-lg overflow-x-auto scrollbar-hide",

  // Center nav items (equal spacing)
  centerNavItemBase:
    "flex-1 min-w-[110px] max-w-[160px] flex flex-col items-center justify-center gap-1 px-2 sm:px-3 lg:px-4 py-3 rounded-2xl text-xs sm:text-sm lg:text-[15px] text-center transition-all duration-300 whitespace-nowrap",
  centerNavItemActive:
    "text-emerald-600 font-semibold bg-emerald-50 shadow-sm scale-[1.02]",
  ...
  rightContainer:
    "flex items-center gap-2 sm:gap-3 shrink-0 min-w-fit",
  signOutButton:
    "hidden xl:flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-amber-500 text-white text-sm shadow-sm hover:opacity-90 transition whitespace-nowrap",
  loginButton:
    "px-4 sm:px-5 py-2 sm:py-2.5 rounded-full border border-emerald-500 bg-white text-emerald-600 text-sm shadow-sm hover:bg-emerald-50 transition whitespace-nowrap",

  // Mobile menu button
  mobileMenuButton:
    "md:hidden p-2.5 rounded-full bg-white border border-gray-200 shadow hover:shadow-md transition",
  ...
  mobileMenuContainer:
    "md:hidden absolute top-full left-0 w-full z-50 px-3 sm:px-4 pt-2",
  mobileMenuInner:
    "rounded-2xl bg-white shadow-xl p-4 space-y-2 border border-gray-100",
  ...
  // Mobile auth section
  mobileAuthContainer:
    "pt-4 border-t mt-3 space-y-2",
  mobileSignOutButton:
    "w-full py-3 rounded-full bg-amber-500 text-white font-medium",
  mobileLoginButton:
    "w-full py-3 rounded-full border border-emerald-500 bg-white text-emerald-600 font-medium",

  // Indicator
  indicator:
    "absolute bottom-1 left-0 h-0.5 bg-emerald-500 transition-all duration-300 ease-out rounded-full",
